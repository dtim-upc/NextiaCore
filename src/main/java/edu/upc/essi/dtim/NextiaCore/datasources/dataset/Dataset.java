...
public class Dataset {
	...
	private GraphJena localGraphJena;
	...
	public GraphJena getLocalGraph() {
		return localGraphJena;
	}

	public void setLocalGraph(GraphJena localGraphJena) {
		this.localGraphJena = localGraphJena;
	}
}